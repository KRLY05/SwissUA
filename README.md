# Інформація для українців що прибули до Швейцарії
...
Деталі по статусу S від юриста: [status-s-schweiz](https://www.status-s-schweiz.org/rus-info)
...
[Українські гості у Женеві та околицях](https://www.facebook.com/groups/354211539939618)
...
Деталі: https://www.allianceswisspass.ch/ukraine
...
4.Вгорі натисніть 'Попередній перегляд' (Preview) для перевірки як буде виглядати сторінка після публікації
5.Внизу сторінки введіть назву та опис змін що ви внесли та натисніть 'Запропонувати зміни' (Propose changes)
